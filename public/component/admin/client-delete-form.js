...
class ClientDeleteForm extends AbstractComponent{
    constructor(info)
    {
        super(); 
    }
    ...
    async #deleteClient()
    {
        try{
            ...
            const response = await util.sendFormData(`/client/delete`, "POST", formData);
        ...
        <style>
            ...
            <div class="card">
                <div class="card-header form-header row-space-between">
                    <span class="fw-semibold">Client 삭제</span>
                ...
                <div class="card-body">
                    <form>
                        ...
                        <hr>
                        <button type="button" class="btn btn-danger form-control command-delete-client">Delete Client</button>
                    </form>
                </div>    
            </div>
        `;  
  ...
  customElements.define('client-delete-form', ClientDeleteForm);
