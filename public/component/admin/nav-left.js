class NavLeft extends AbstractComponent
{
  ...
  #showTagComponent(node)
  {
    ...
    if(type) component.setAttribute('type', type);
    document.querySelector('.page-inner').innerHTML = '';
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary ">
              ...
              <li class="nav-item">
                <a href="#" class="command-show-component" tag="contact-list" type="new">
                  <i class="fas fa-calendar-check"></i>
                  <p>문의사항</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="#" class="command-show-component" tag="contact-list" type="old">
                  <i class="fas fa-calendar-check"></i>
                  <p>완료된 문의사항</p>
                </a>
              </li>
